<%@page import="in.co.job.portal.controller.UserCtl"%>
		...
		<div class="row justify-content-center">
			<div class="col-md-8">
				<div class="card">
					...
					<%if(bean.getRoleId()==2L){ %>
						Update Recruiter
						<%}else if(bean.getRoleId()==3L){ %>
						Update User 
						<%}else{%>
						Add Recruiter
						<%} %>
					...
					<div class="card-body">
,
						<form action="<%=JPView.USER_CTL%>" method="post">
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input type="date" id="email_address" id="datepicker" class="form-control" placeholder="Enter Date Of Birth"
										name="dob" value="<%=DataUtility.getDateString1(bean.getDob())%>" >
